...
export var setTip = (userId, gameId, tipTeamId) => {
  ...
  if (tipTeamId === undefined) {
    ...
    firebaseRef.child(`season-2019-tips/${userId}/tips/${gameId}`).remove();
  }
  else {
    // firebaseRef.child(`tips/${userId}/tips/${gameId}`).set(tipTeamId);
    firebaseRef.child(`season-2019-tips/${userId}/tips/${gameId}`).set(tipTeamId);
  }
...
export var startAddTips = () => {
  ...
  return (dispatch, getState) => {
    ...
    var tipsRef = firebaseRef.child(`season-2019-tips`);
