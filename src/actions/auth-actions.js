...
export function saveUser (user, firstname) {
  ...
  var defURL = 'https://firebasestorage.googleapis.com/v0/b/li-tips.appspot.com/o/userimages%2Fafl.png?alt=media&token=4f0a7b15-371d-4445-9a7b-89bce62801d4';
  ...
  console.log(`User info ...id:${user.uid}, email:${user.email}, firstname:${firstname}, url:${defURL}`)
